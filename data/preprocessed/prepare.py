...
FILES = [
    ...
    {'filename': 'oceans/oceans', 'post_sql': 'insert into vectiles_input.oceans (geom) select st_setsrid(st_geomfromgeojson(geometry::text), 4326) as geom from (select datas#>\'{geometry}\' as geometry from data_upload) f'},
